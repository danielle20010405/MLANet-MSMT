...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1x1_adjust = nn.Conv2d(self.num_inchannels[3], 2049, kernel_size=1)
            
        self.conv1x1_2048 = nn.Conv2d(2049, 2048, kernel_size=1)
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # print(x.shape)
        x = self.atten_done(self.conv1x1_adjust(x))
        x = self.conv1x1_2048(x)
