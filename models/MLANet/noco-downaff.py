...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        # self.bottle_atten = CoordAtt(width, width)
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = self.fusion[0](x2, self.downsample[0](x1))
        x = self.fusion[1](x3, self.downsample[1](x))
        x = self.fusion[2](x4, self.downsample[2](x))
