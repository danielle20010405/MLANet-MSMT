...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.atten = CoordAtt(width, width)
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        # self.atten = CoordAtt(self.inplanes, self.inplanes)
        ...
        self.aff = AFF(self.inplanes)
        self.up = nn.Upsample(scale_factor=2, mode='bilinear')
        self.conv1x1_1 = nn.Conv2d(256, 2048, kernel_size=1)
        self.conv1x1_2 = nn.Conv2d(512, 2048, kernel_size=1)
        self.conv1x1_3 = nn.Conv2d(1024, 2048, kernel_size=1)
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x4_up = self.up(x4)  
        x3 = self.aff(x4_up, self.conv1x1_3(x3))  

        x3_up = self.up(x3)  
        x2 = self.aff(x3_up, self.conv1x1_2(x2))  

        x2_up = self.up(x2)  
        x1 = self.aff(x2_up, self.conv1x1_1(x1))
