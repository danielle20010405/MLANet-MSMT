...
def main():
    # 初始化模型
    model = define_net_recon(net_recon='resnet50', use_last_fc=False, init_path="../../checkpoints/deep3d/allnet/epoch_34.pth")
    print(model)
    model.eval()  # 切换到评估模式
    ...
    # 指定单张图像的路径
    img_path = "../../dataset/deep3d/AFLW2000-3D/img/example_val/image03773.jpg"
    assert os.path.exists(img_path), f"file: '{img_path}' does not exist."
