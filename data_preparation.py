...
parser.add_argument('--data_root', type=str, default='../../dataset/deep3d', help='root directory for training data')
...
def data_prepare(folder_list,mode):
    ...
    for img_folder in tqdm(folder_list, desc="Processing folders"):
    ...
    msks_list = []
    for img_folder in tqdm(folder_list, desc="Generating masks list"):
